<?php
	...
	if(isset($_SESSION['estado'])){ 
        ...
        $nombre = htmlspecialchars($nombreSesion);
        $apellido = htmlspecialchars($apellidoSesion);
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<title>Inicio | Bienvenido <?php echo $nombre." ".$apellido; ?> Censo Poblacional 2018</title>
